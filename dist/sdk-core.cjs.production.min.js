...
var P = (function(t) {
    function r(r, n, e, i, o) {
      var a
      return (
        ((a = t.call(this, e, i, o) || this).isEther = !1), (a.isToken = !0), (a.chainId = r), (a.address = U(n)), a
      )
    }
    l(r, t)
    var n = r.prototype
  ...
  S =
    (((w = {})[exports.ChainId.MAINNET] = new P(
    ...
    (w[exports.ChainId.ROPSTEN] = new P(
    ...
    (w[exports.ChainId.RINKEBY] = new P(
    ...
    (w[exports.ChainId.EVMOS_TESTNET] = new P(
...
;(exports.CurrencyAmount = F),
  ...
  (exports.validateAndParseAddress = U),
