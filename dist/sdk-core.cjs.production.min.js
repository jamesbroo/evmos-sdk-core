...
var U = (function(t) {
    function r(r, n, e, i, o) {
      var a
      return (
        ((a = t.call(this, e, i, o) || this).isEther = !1), (a.isToken = !0), (a.chainId = r), (a.address = D(n)), a
      )
    }
    l(r, t)
    var n = r.prototype
...
;(exports.CurrencyAmount = F),
  ...
  (exports.sqrt = function(t) {
    ...
    var r, n
    for (r = t, n = i.add(i.divide(t, M), q); i.lessThan(n, r); ) (r = n), (n = i.divide(i.add(i.divide(t, n), n), M))
    return r
  }),
  (exports.validateAndParseAddress = D),
  (exports.wrappedCurrency = W),
  (exports.wrappedCurrencyAmount = function(t, r) {
    return F.fromFractionalAmount(W(t.currency, r), t.numerator, t.denominator)
  })
