...
;((r = exports.ChainId || (exports.ChainId = {}))[(r.MAINNET = 1)] = 'MAINNET'),
  ...
  (r[(r['GÖRLI'] = 5)] = 'GÖRLI'),
  (r[(r.KOVAN = 42)] = 'KOVAN'),
  (r[(r.EVMOS = 9001)] = 'EVMOS'),
  (r[(r.EVMOS_TESTNET = 9e3)] = 'EVMOS_TESTNET'),
...
var h = function(t, r, n) {
  ...
  y = (function(t) {
    function r() {
      var r
      return ((r = t.call(this, 18, 'EVMOS', 'Evmos') || this).isEther = !0), (r.isToken = !1), r
    }
    return l(r, t), r
  })(h)
y.ETHER = new y()
var E,
  ...
  T = s(u),
  N =
    (((E = {})[exports.Rounding.ROUND_DOWN] = x.ROUND_DOWN),
    (E[exports.Rounding.ROUND_HALF_UP] = x.ROUND_HALF_UP),
    (E[exports.Rounding.ROUND_UP] = x.ROUND_UP),
    E),
  I =
    (((v = {})[exports.Rounding.ROUND_DOWN] = 0),
    (v[exports.Rounding.ROUND_HALF_UP] = 1),
    (v[exports.Rounding.ROUND_UP] = 3),
    v),
  R = (function() {
    function t(t, r) {
    ...
    return (
      ...
      (r.toSignificant = function(t, r, n) {
        void 0 === r && (r = { groupSeparator: '' }),
          ...
          t > 0 || o(!1),
          x.set({ precision: t + 1, rounding: N[n] })
        var e = new x(this.numerator.toString()).div(this.denominator.toString()).toSignificantDigits(t)
      ...
      (r.toFixed = function(t, r, n) {
        return (
          ...
          (T.DP = t),
          (T.RM = I[n]),
          new T(this.numerator.toString()).div(this.denominator.toString()).toFormat(t, r)
        )
      }),
      p(t, [
        {
  ...
  F = (function(t) {
    ...
    return (
      (n.add = function(n) {
        m(this.currency, n.currency) || o(!1)
      ...
      (n.toExact = function(t) {
        return (
          ...
          (O.DP = this.currency.decimals),
          new O(this.quotient.toString()).div(this.decimalScale.toString()).toFormat(t)
        )
      }),
      r
    )
...
function C(t) {
  return new _(t.numerator, t.denominator)
}
var w,
  _ = (function(t) {
    function r() {
    ...
    return (
      (n.add = function(r) {
        return C(t.prototype.add.call(this, r))
      }),
      (n.subtract = function(r) {
        return C(t.prototype.subtract.call(this, r))
      }),
      (n.multiply = function(r) {
        return C(t.prototype.multiply.call(this, r))
      }),
      (n.divide = function(r) {
        return C(t.prototype.divide.call(this, r))
      }),
      (n.toSignificant = function(r, n, e) {
        return void 0 === r && (r = 5), t.prototype.multiply.call(this, A).toSignificant(r, n, e)
      }),
      (n.toFixed = function(r, n, e) {
        return void 0 === r && (r = 2), t.prototype.multiply.call(this, A).toFixed(r, n, e)
      }),
      r
    )
  })(R),
  D = (function(t) {
    ...
    return (
      ...
      (n.multiply = function(n) {
        m(this.quoteCurrency, n.baseCurrency) || o(!1)
        var e = t.prototype.multiply.call(this, n)
        return new r(this.baseCurrency, n.quoteCurrency, e.denominator, e.numerator)
      }),
      (n.quote = function(r) {
        m(r.currency, this.baseCurrency) || o(!1)
        var n = t.prototype.multiply.call(this, r)
        return F.fromFractionalAmount(this.quoteCurrency, n.numerator, n.denominator)
      }),
...
var U = (function(t) {
    function r(r, n, e, i, o) {
      var a
      return (
        ((a = t.call(this, e, i, o) || this).isEther = !1), (a.isToken = !0), (a.chainId = r), (a.address = S(n)), a
      )
    }
    l(r, t)
    var n = r.prototype
  ...
  P =
    (((w = {})[exports.ChainId.MAINNET] = new U(
    ...
    (w[exports.ChainId.ROPSTEN] = new U(
    ...
    (w[exports.ChainId.RINKEBY] = new U(
    ...
    (w[exports.ChainId.EVMOS_TESTNET] = new U(
    ...
    w),
  b = i.BigInt(Number.MAX_SAFE_INTEGER),
  B = i.BigInt(0),
  q = i.BigInt(1),
  W = i.BigInt(2)
function H(t, r) {
  if (t.isToken) return t.chainId !== r && o(!1), t
  if (t.isEther) return P[r]
  throw new Error('CURRENCY')
}
;(exports.CurrencyAmount = F),
  (exports.ETHER = g),
  (exports.Ether = y),
  (exports.Fraction = R),
  ...
  (exports.computePriceImpact = function(t, r, n) {
    ...
    return new _(i.numerator, i.denominator)
  }),
  (exports.currencyEquals = m),
  ...
  (exports.sqrt = function(t) {
    if ((i.greaterThanOrEqual(t, B) || o(!1), i.lessThan(t, b))) return i.BigInt(Math.floor(Math.sqrt(i.toNumber(t))))
    var r, n
    for (r = t, n = i.add(i.divide(t, W), q); i.lessThan(n, r); ) (r = n), (n = i.divide(i.add(i.divide(t, n), n), W))
    return r
  }),
  (exports.validateAndParseAddress = S),
  (exports.wrappedCurrency = H),
  (exports.wrappedCurrencyAmount = function(t, r) {
    return F.fromFractionalAmount(H(t.currency, r), t.numerator, t.denominator)
  })
